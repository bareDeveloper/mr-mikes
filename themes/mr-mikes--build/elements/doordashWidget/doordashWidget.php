<div class="restaurant restaurantWidget restaurantWidget--doordash">
    ...
    <div class="listFilter">
        ...
        <ul class="restaurantWidget__list list">
            ...
            foreach ($postslist as $post) :  
                ...
                $link = get_field('door_dash', $post_id);
                ...
                if (!is_wp_error($terms) && $open != 'closed') {
                    ...
                    <li class="restaurantWidget__link-container">
                        <a class="restaurantWidget__link" href="<?php echo $link['url']; ?>" target="_blank">
