(function ( $ ) {
	...
	window['InlineShortcodeView_wpcdt-countdown'] = window.InlineShortcodeView.extend({
		render: function () {
			var model_id = this.model.get( 'id' );
			window['InlineShortcodeView_wpcdt-countdown'].__super__.render.call( this );
			vc.frame_window.vc_iframe.addActivity( function () {
				this.wpcdt_pro_all_timer_init();
			});
			return this;
		}
	});

	window['InlineShortcodeView_wpcdt_timer'] = window.InlineShortcodeView.extend({
		render: function () {
			var model_id = this.model.get( 'id' );
			window['InlineShortcodeView_wpcdt_timer'].__super__.render.call( this );
			vc.frame_window.vc_iframe.addActivity( function () {
				this.wpcdt_pro_all_timer_init();
			});
			return this;
	...
	window.vc.events.on( 'shortcodeView:ready', function ( model ) {
		wpcdt_pro_vc_init_shortcodes( model );
	});

	/* Initialize Plugin Shortcode */
	function wpcdt_pro_vc_init_shortcodes( model ) {
		...
		if( settings.base == 'vc_raw_html'
			...
			window.vc.frame_window.wpcdt_pro_all_timer_init();
		}
	}
