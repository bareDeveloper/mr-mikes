( function($) {
	...
	jQuery(window).on('elementor/frontend/init', function() {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/wp-widget-text.default', wpcdt_pro_elementor_init );
		elementorFrontend.hooks.addAction( 'frontend/element_ready/shortcode.default', wpcdt_pro_elementor_init );
		elementorFrontend.hooks.addAction( 'frontend/element_ready/text-editor.default', wpcdt_pro_elementor_init );

		/* Tabs Element */
		elementorFrontend.hooks.addAction( 'frontend/element_ready/tabs.default', function( $scope ) {

			$scope.find('.wpcdt-timer-circle').each(function( index ) {
	 ...
	 */
	function wpcdt_pro_elementor_init() {
		wpcdt_pro_all_timer_init();
	}
